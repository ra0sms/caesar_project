...
# Audio stream
gst-launch-1.0   alsasrc device=hw:0 buffer-time=100000 latency-time=1000 !   audioconvert !   audioresample !   capsfilter caps="audio/x-raw,rate=48000,channels=1,format=S16LE" !   opusenc bitrate=24000 frame-size=10 complexity=3 !   rtpopuspay !   udpsink host=$IP_ADDRESS port=5002 sync=false
